...
final class AntiReplayTest extends TestCase
{
     ...
     * 测试获取和设置配置
     */
    public function testSetAndGetConfigStoresCorrectly(): void
    {
     ...
     * 测试缓冲区长度不足时的行为
     */
    public function testInputWithShortBufferReturnsCheckLength(): void
    {
     ...
     * 测试首次收到某数据时的正常行为
     */
    public function testInputWithFirstTimeBufferReturnsBufferLength(): void
    {
     ...
     * 测试重复收到相同数据时的拒绝行为
     */
    public function testInputWithReplayedBufferReturnsZero(): void
    {
        ...
        $this->logger->expects($this->once())
            ->method('error')
            ->with(self::stringContains('检测到重放攻击'))
        ;
     ...
     * 测试已通过检查的连接的行为
     */
    public function testInputWithPassedConnectionReturnsBufferLength(): void
    {
        $buffer = str_repeat('a', 100); // 100字节
     ...
     * 测试解码方法
     */
    public function testDecodeReturnsOriginalData(): void
    {
        $data = 'test data';
     ...
     * 测试编码方法
     */
    public function testEncodeReturnsOriginalData(): void
    {
        $data = 'test data';
     ...
     * 测试空缓冲区的边界情况
     */
    public function testInputWithEmptyBufferReturnsCheckLength(): void
    {
        $buffer = '';
     ...
     * 测试超大缓冲区的处理
     */
    public function testInputWithLargeBufferReturnsBufferLength(): void
    {
